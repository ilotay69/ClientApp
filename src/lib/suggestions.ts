...
1. urgent_alert — anything time-sensitive: an outage, a security or compliance notice, an angry or urgent-sounding customer, a high-priority ticket that's been open a long time with no apparent resolution, a task marked OVERDUE above (especially high priority), a device that's OFFLINE with a last-contact gap of several days or more (could mean a dead machine, a network outage, or an unpatched security risk going unmonitored), anything that shouldn't wait.
...
6. opportunity — a possible upsell or new-service signal that isn't urgent, including a device running a clearly outdated/end-of-life OS (e.g. Windows 7/8, Server 2008/2012) worth a hardware or OS refresh conversation.
