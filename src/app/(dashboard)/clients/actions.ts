...
/** Logging a Note/Call/Meeting is open to any signed-in user — only
 * editing the client record itself and managing its contact list require
 * manage_clients. Relationship check-ins (contact method, outcome, next
 * contact date) live on the owner-only Touchpoints page instead of here
 * now — this used to also create a matching Touchpoint, but that linkage
 * went away with it. */
