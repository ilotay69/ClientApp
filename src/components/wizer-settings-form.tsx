...
export function WizerSettingsForm({
  hasCredentials,
  saveAction,
  testAction,
}: {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h2 className="text-sm font-semibold text-slate-900">Wizer</h2>
      ...
      <p className="mt-4 text-xs text-slate-500">
        Generate a key under Settings → Integration in your Wizer admin panel
        (admin.wizer-training.com). This just confirms the connection for now — a per-client
        company mapping and lookups (training completion, phishing simulation results) are a
