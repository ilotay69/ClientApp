        ...
        >
          ...
          >
            <p className="text-sm text-slate-500">
              Enter this client&apos;s own Microsoft 365 app registration — created and consented
              by their admin, in their own tenant.
            </p>
            <form action={formAction} className="mt-3 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={
                    hasCredentials ? "Leave blank to keep the current secret" : "Paste the app's client secret"
                  }
                  autoComplete="off"
                  className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
                />
